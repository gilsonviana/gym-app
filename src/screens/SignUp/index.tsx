    ...
    return (
        <ScrollView contentContainerStyle={{flex: 1, backgroundColor: theme.color.light}}>
            <View style={styles.container}>
                <TextInput style={styles.input} onChangeText={value => handleFormOnChange('firstName', value)} placeholder="First name"/>
                <TextInput style={styles.input} onChangeText={value => handleFormOnChange('lastName', value)} placeholder="Last name"/>
                <TextInput style={styles.input} onChangeText={value => handleFormOnChange('email', value)} placeholder="Email address"/>
                <TextInput style={styles.input} onChangeText={value => handleFormOnChange('password', value)} placeholder="Password" secureTextEntry={true}/>
